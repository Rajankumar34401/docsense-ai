...
flowchart LR
    ...
    %% System Boundary
    subgraph System["DocSens-AI System Boundary"]
        ...
        UC8[Invite Admin]
        UC9[Grant / Revoke Permissions]
        UC10[Manage Users & Documents]

        UC11[Generate Embeddings]
        UC12[Vector Search]
        UC13[Generate AI Response]
        UC14[Stream Response (SSE)]
